...
public class Uso {
	...
	public static void main(String[] args)
	{
		...
		*/
		...
		///////////////////////////////////////////////////
		VeiculoSmart carroteste = new VeiculoSmart(false, true, true, true);
		while(Button.ESCAPE.isUp())
		{
			carroteste.coletaAmostras();
			System.out.println("dir"+carroteste.amostras[0]+" esq" + carroteste.amostras[1]);
		}
		carroteste.segueLinha("direito", "esquerdo");
